        ...
        http.csrf(csrf -> csrf.ignoringRequestMatchers("/api/**").disable())
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/api/news/", "/api/ncategories/", "/api/projects/", "/api/projects/{id}", "/api/pcategories/",
                                ...
                                "/api/firebase/{userId}", "/api/users/", "/api/users/{id}", "/api/post/tags/{id}",
                                "/api/user-docs/{id}", "/api/projects/{id}", "/api/projects/pcategories/{id}",
                                "/api/news/ncategories/{id}/", "/api/export/", "/api/contributions/", "/api/projects/images/{id}",
                                ...
                                "/api/public-posts/", "/api/notifications/{userId}", "/api/tags/**", "/api/tags/{id}", "api/tags/{name}", "api/mark-as-read/{userId}", 
                                "/api/export/", "/api/item-export/", "/api/payment-export/", "/api/monthly/", "/api/quarterly/", "/api/yearly/", "/api/other-news/", "/api/feedback/{projectId}")
                        .permitAll()
